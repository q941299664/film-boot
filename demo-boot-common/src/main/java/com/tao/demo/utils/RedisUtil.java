...
public class RedisUtil {
  ...
  public boolean hasKey(String key) {
    try {
      return Boolean.TRUE.equals(myRedisTemplate.hasKey(key));
    } catch (Exception e) {
      log.error(key, e);
      return false;
    }
  ...
  public void del(String... key) {
    if (key != null && key.length > 0) {
      if (key.length == 1) {
        ...
        myRedisTemplate.delete((List<String>) CollectionUtils.arrayToList(key));
      }
    }
  }
  ...
  public boolean sHasKey(String key, Object value) {
    try {
      return Boolean.TRUE.equals(myRedisTemplate.opsForSet().isMember(key, value));
    } catch (Exception e) {
      log.error(key, e);
      return false;
    }
  ...
  public Boolean zSSet(String key, Object value, double score) {
    try {
      return myRedisTemplate.opsForZSet().add(key, value, 2);
    } catch (Exception e) {
      log.error(key, e);
      return false;
    }
